...
type Tab = 'profile' | 'security' | 'accounts' | 'subscription' | 'referrals'
    ...
    <>
      ...
      <div className="settings-layout">
        ...
        <div className="settings-sidebar">
          ...
          {([['profile', '👤', 'Profile'], ['security', '🔒', 'Security'], ['accounts', '🏦', 'Trading Accounts'], ['subscription', '💳', 'Subscription'], ['referrals', '🎁', 'Refer & Earn']] as const).map(([t, icon, label]) => (

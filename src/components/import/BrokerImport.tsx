  ...
  return (
    <div style={{ maxWidth: '700px', margin: '0 auto' }}>
      ...
      <div style={{ position: 'relative', marginBottom: '28px' }}>
        ...
        <input className="fi" type="text" placeholder="Search broker or trading platform..." value={search} onChange={e => setSearch(e.target.value)} style={{ paddingLeft: '34px', width: '100%' }} />
      </div>

...
- Competitors: Tradezella, Tradervue, Edgewonk
...
- Reading charts, understanding metrics

Keep responses concise, friendly, and helpful. You are a knowledgeable trading assistant. If asked about pricing or features, be accurate. For trading advice, be educational but always note that you are not a financial advisor.`
...
export function SleektradeChat() {
  ...
  async function sendMessage() {
    ...
    try {
      ...
      const text = data.content?.[0]?.text || 'Sorry, I could not get a response. Please try again.'

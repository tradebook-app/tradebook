    ...
    <div style={{ background: 'var(--bg)', color: 'var(--txt)', fontFamily: 'var(--sans)', minHeight: '100vh' }}>
      ...
      <section id="features" style={{ maxWidth: '1200px', margin: '0 auto', padding: '80px 48px' }} className="section-pad">
        ...
        <div style={{ marginBottom: '100px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '340px 1fr', gap: '56px', alignItems: 'flex-start' }}>
            {/* Left: text */}
            ...
            {/* Right: big mock */}
            <div style={{ background:'#131318', border:'1px solid #252530', borderRadius:'16px', padding:'18px', boxShadow:'0 24px 80px rgba(0,0,0,.5)' }}>
              <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'12px' }}>
                <span style={{ fontSize:'13px', fontWeight:700 }}>Trade View</span>
                <div style={{ display:'flex', gap:'5px' }}>
                  {['All','LONG','SHORT','Winners','Losers'].map((f,i) => (
                    <span key={f} style={{ fontSize:'10px', padding:'3px 9px', borderRadius:'6px', background:i===0?'#10B981':'#1e1e26', color:i===0?'#000':'#666', border:'1px solid #2a2a35', fontWeight:600 }}>{f}</span>
                  ))}
                </div>
              </div>
              <div style={{ display:'grid', gridTemplateColumns:'95px 70px 62px 80px 80px 60px 80px 55px 80px 1fr', padding:'7px 12px', borderBottom:'1px solid #252530', background:'#16161e', borderRadius:'6px 6px 0 0' }}>
              ...
              {[
                ...
                <div key={i} style={{ display:'grid', gridTemplateColumns:'95px 70px 62px 80px 80px 60px 80px 55px 80px 1fr', padding:'6px 12px', borderBottom:'1px solid #1e1e26', alignItems:'center', background:i%2===0?'transparent':'rgba(255,255,255,.01)' }}>
                  <span style={{ fontSize:'9px', color:'#555', fontFamily:'monospace' }}>{t.date}</span>
                  ...
                  <span style={{ fontSize:'9px', color:'#555' }}>{t.setup}</span>
                  <span style={{ fontSize:'9px', color:'#444', overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>{t.note}</span>
                </div>
              ))}
              <div style={{ display:'flex', justifyContent:'space-between', padding:'8px 12px', fontSize:'10px', color:'#555', borderTop:'1px solid #252530' }}>
            ...
            <div style={{ background:'#131318', border:'1px solid #252530', borderRadius:'16px', padding:'18px', boxShadow:'0 24px 80px rgba(0,0,0,.5)' }}>
              <div style={{ display:'flex', gap:'5px', marginBottom:'14px', flexWrap:'wrap' }}>
                {['Performance','Overview','Day & Time','Symbols','Risk/R','Win/Loss','Setups'].map((t,i) => (
                  <div key={t} style={{ fontSize:'10px', fontWeight:600, padding:'5px 12px', borderRadius:'6px', background:i===0?'#10B981':'#1e1e26', color:i===0?'#000':'#666', border:'1px solid #2a2a35' }}>{t}</div>
                ))}
              </div>
              <div style={{ display:'grid', gridTemplateColumns:'repeat(6,1fr)', gap:'8px', marginBottom:'14px' }}>
                {[
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:'10px', marginBottom:'14px' }}>
                <div style={{ background:'#1a1a22', border:'1px solid #252530', borderRadius:'8px', padding:'12px' }}>
                  <div style={{ fontSize:'9px', color:'#555', marginBottom:'10px' }}>P&L by Day of Week</div>
                  <div style={{ display:'flex', gap:'6px', alignItems:'flex-end', height:'70px' }}>
                    {[{d:'Mon',h:55,c:'#10B981'},{d:'Tue',h:78,c:'#10B981'},{d:'Wed',h:22,c:'#EF4444'},{d:'Thu',h:65,c:'#10B981'},{d:'Fri',h:45,c:'#10B981'}].map(b => (
                      <div key={b.d} style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center', gap:'4px', justifyContent:'flex-end' }}>
                        <div style={{ width:'100%', height:`${b.h}%`, background:b.c, borderRadius:'3px 3px 0 0', opacity:0.85 }} />
                        <div style={{ fontSize:'8px', color:'#555' }}>{b.d}</div>
                      </div>
                    ))}
                  </div>
                ...
                <div style={{ background:'#1a1a22', border:'1px solid #252530', borderRadius:'8px', padding:'12px' }}>
                  <div style={{ fontSize:'9px', color:'#555', marginBottom:'10px' }}>Best Time of Day</div>
                  <div style={{ display:'flex', gap:'4px', alignItems:'flex-end', height:'70px' }}>
                    {[{t:'9:30',h:80},{t:'10:00',h:95},{t:'11:00',h:45},{t:'12:00',h:20},{t:'14:00',h:50},{t:'15:00',h:65},{t:'15:30',h:35}].map(b => (
                ...
                <div style={{ background:'#1a1a22', border:'1px solid #252530', borderRadius:'8px', padding:'12px' }}>
                  <div style={{ fontSize:'9px', color:'#555', marginBottom:'10px' }}>Top Symbols</div>
                  {[{s:'NVDA',pnl:'+$2,140',wr:'79%'},{s:'TSLA',pnl:'+$1,570',wr:'72%'},{s:'SPY',pnl:'+$960',wr:'68%'},{s:'QQQ',pnl:'+$540',wr:'64%'},{s:'AAPL',pnl:'-$210',wr:'42%'}].map(x => (
                    <div key={x.s} style={{ display:'grid', gridTemplateColumns:'40px 1fr 35px 55px', alignItems:'center', marginBottom:'7px', gap:'6px' }}>
                      <span style={{ fontSize:'11px', fontWeight:700 }}>{x.s}</span>
                      ...
                      <span style={{ fontSize:'10px', fontWeight:700, color:x.pnl.startsWith('+')?'#10B981':'#EF4444', fontFamily:'monospace' }}>{x.pnl}</span>
                    </div>
                  ))}
                </div>
              </div>

    ...
    <div style={{ background: 'var(--bg)', color: 'var(--txt)', fontFamily: 'var(--sans)', minHeight: '100vh' }}>
      ...
      <section id="pricing" style={{ maxWidth: '1000px', margin: '0 auto', padding: '80px 48px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '32px' }}>
          <span style={{ fontSize: '13px', color: 'var(--txt2)', fontWeight: 600 }}>Monthly</span>
          <div style={{ background: 'var(--bg3)', border: '1px solid var(--brd2)', borderRadius: '20px', padding: '3px', display: 'flex', gap: '2px' }}>
            <div style={{ background: '#10B981', borderRadius: '16px', padding: '5px 16px', fontSize: '11px', fontWeight: 700, color: '#000' }}>Monthly</div>
            <div style={{ borderRadius: '16px', padding: '5px 16px', fontSize: '11px', fontWeight: 600, color: 'var(--txt3)' }}>Yearly <span style={{ color: '#10B981' }}>-20%</span></div>
          </div>
          <span style={{ fontSize: '11px', color: '#10B981', fontWeight: 700, background: 'rgba(16,185,129,.1)', border: '1px solid rgba(16,185,129,.2)', borderRadius: '20px', padding: '2px 10px' }}>Save 2 months</span>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '16px', alignItems: 'stretch' }}>
          ...
          <div style={{ background: 'var(--bg2)', border: '1px solid var(--brd)', borderRadius: '14px', padding: '28px', display: 'flex', flexDirection: 'column' }}>
            ...
            <Link href="/signup" style={{ display: 'block', textAlign: 'center', marginTop: '28px', fontSize: '13px', fontWeight: 600, color: 'var(--txt)', background: 'var(--bg4)', border: '1px solid var(--brd2)', borderRadius: '8px', padding: '11px', textDecoration: 'none' }}>Get started free</Link>
          </div>
          {/* Pro */}
          <div style={{ background: 'var(--bg2)', border: '2px solid #10B981', borderRadius: '14px', padding: '28px', position: 'relative', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ fontSize: '40px', fontWeight: 800, marginBottom: '4px' }}>$19</div>
            ...
            <Link href="/signup" style={{ display: 'block', textAlign: 'center', marginTop: '28px', fontSize: '13px', fontWeight: 700, color: '#000', background: '#10B981', borderRadius: '8px', padding: '11px', textDecoration: 'none' }}>Start free trial</Link>
          </div>
          {/* Elite */}
          <div style={{ background: 'linear-gradient(145deg, #0f1f1a, #0a1a14)', border: '1px solid rgba(16,185,129,.3)', borderRadius: '14px', padding: '28px', display: 'flex', flexDirection: 'column' }}>
            ...
            <Link href="/signup" style={{ display: 'block', textAlign: 'center', marginTop: '28px', fontSize: '13px', fontWeight: 700, color: '#10B981', background: 'rgba(16,185,129,.1)', border: '1px solid rgba(16,185,129,.3)', borderRadius: '8px', padding: '11px', textDecoration: 'none' }}>Get Elite access</Link>
          </div>
        </div>
      </section>
